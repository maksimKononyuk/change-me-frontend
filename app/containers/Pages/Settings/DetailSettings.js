          ...
          <Grid item md={8} xs={12}>
            <List>
              <ListItem>
                <ListItemText
                  primary="Контент"
                  secondary="Показывать клиентам чужой контент"
                />
              ...
              <ListItem>
                <ListItemText
                  primary="Another checkbox input"
                  secondary="Donec dignissim"
                />
                <ListItemSecondaryAction>
                  <Checkbox
            ...
            <List
              subheader={
                <ListSubheader component="div">Nested List Two</ListSubheader>
              }
            >
              <ListItem>
                <ListItemText
                  primary="Switch input"
                  secondary="Odio ac imperdiet luctus"
                />
                <ListItemSecondaryAction>
                  <Switch
                    onChange={() => handleToggle('switch')}
